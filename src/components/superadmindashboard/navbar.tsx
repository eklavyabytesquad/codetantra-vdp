  ...
  const menuItems = [
    {
      ...
      icon: Shield,
      items: [
        { label: 'Create Department', icon: PlusCircle, href: '/create-department' },
        { label: 'Department List', icon: Building, href: '/departments' },
        { label: 'System Analytics', icon: BarChart2, href: '/analytics' }
      ]
    },
    {
      label: 'Management',
      icon: Layers,
      items: [
        { label: 'Admin Directory', icon: Users, href: '/admins' },
        { label: 'Add New Admin', icon: UserPlus, href: '/add-admin' },
        { label: 'View Reports', icon: BookOpen, href: '/reports' }
      ]
    }
  ];
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/dashboard" className="relative group">
            <div className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 
              ...
              ClassPro.io<span className="text-blue-600 dark:text-blue-400"> SuperAdmin</span>
            </div>
